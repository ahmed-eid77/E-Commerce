                                                ...
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{ route('product.details', ['slug' => $RProduct->slug]) }}" tabindex="0">
                                                            <img class="default-img" src="{{asset('/assets/imgs/shop/product-')}}{{$RProduct->id}}-1.jpg" alt="{{$RProduct->name}}"alt="">
                                                            <img class="hover-img" src="{{ asset('assets/imgs/shop/product-2-2.jpg')}}" alt="{{ $RProduct->name }}">
                                                        </a>
                                                    </div>
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                            ...
                            @foreach ($NProducts as $NProduct)
                                <div class="single-post clearfix">
                                    <div class="image">
                                        <img src="{{asset('/assets/imgs/shop/product-')}}{{$NProduct->id}}-1.jpg" alt="{{$NProduct->name}}" alt="#">
                                    </div>
