                                ...
                                <div class="sort-by-cover">
                                    ...
                                    <div class="sort-by-dropdown">
                                        <ul>
                                            ...
                                            <li><a href="#" class="{{ $orderBy =='Release Date' ? 'active' : '' }}" wire:click.prevent="changeOrderBy('Release Date')">Release Date</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('product.details', ['slug' => $product->slug]) }}">
                                                ...
                                                <img class="hover-img" src="{{asset('/assets/imgs/shop/product-')}}{{$product->id}}-1.jpg" alt="{{$product->name}}" title="{{$product->name}}">
                                            </a>
                                        </div>
